...
if escolha == "1":
  ...
  print(f'O resultado da conversão de {grau}°F para Celsius(°C) é: {(grau-32)/1.8}')
if escolha == "2":
  print("\nConversor de Celsius(°C)-> Fahrenheit(°F)\n")
  grau = float(input("Insira o valor a ser convertido: "))
  print(f'O resultado da conversão de {grau}°C para Fahrenheit(°F) é: {(grau*1.8)+32}')
if escolha == "3":
  print("\nConversor de Celsius(°C)-> Kelvin(K)\n")
  grau = float(input("Insira o valor a ser convertido: "))
  print(f'O resultado da conversão de {grau}°C para Kelvin(K) é: {grau+273.15}')
if escolha == "4":
  print("\nConversor de Kelvin(K) -> Celsius(°C)\n")
  grau = float(input("Insira o valor a ser convertido: "))
  print(f'O resultado da conversão de {grau}°K para Celsius(°C) é: {grau-273.15}')